<tr>
                  <td><table width="260" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><img name="body_r1_c9" src="images/order_installer_management_heading.jpg" width="260" height="48" border="0" alt="" /></td>
                    </tr>
                    <tr>
                      <td height="109" width="100%" align="center" valign="top" class="columnBox">
					  	<table width="100%" cellspacing="0" cellpadding="0">
							...
							<?php
								$query = $database->query("select p.page_id, p.page_url, pd.name from " . TABLE_PAGES . " p, " . TABLE_PAGES_DESCRIPTION . " pd, " . TABLE_USER_GROUPS_TO_PAGES . " ugtp, " . TABLE_PAGES_GROUPS . " pg where pg.file_name = '" . 'installer_assignments.php' . "' and pg.page_group_id = p.page_group_id and p.page_id = ugtp.page_id and ugtp.user_group_id = '" . $user->fetch_user_group_id() . "' and p.page_id = pd.page_id and pd.language_id = '" . $language_id . "' order by pd.name ASC");
								$count = 0;
