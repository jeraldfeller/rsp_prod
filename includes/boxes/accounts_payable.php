<tr>
                  <td><table width="260" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><img name="body_r1_c9" src="images/accounts_payable.jpg" width="260" height="48" border="0" alt="" /></td>
                    </tr>
                    <tr>
										...
										<td class="style6" width="100%" align="left" height="19">
											<table width="100%" cellspacing="0" cellpadding="0">
												<tr>
													...
													<td height="19" class="columnBoxLeftBody" align="left" valign="middle" width="100%" NOWRAP><a class="columnBoxLeftBody" href="<?php echo FILENAME_ACCOUNTS_PAYABLE_ORDERS; ?>">Accounts Payable Orders</a></td>
												</tr>
											</table>
										</td>
									</tr>
										...
										<td class="style6" width="100%" align="left" height="19">
											<table width="100%" cellspacing="0" cellpadding="0">
												<tr>
													...
													<td height="20" width="19" align="left" valign="middle"><img src="images/column_arrow.gif" height="9" width="8" /></td>
													<td width="10" height="19"><img src="images/pixel_trans.gif" height="19" width="10"></td>
													<td height="19" class="columnBoxLeftBody" align="left" valign="middle" width="100%" NOWRAP><a class="columnBoxLeftBody" href="<?php echo FILENAME_ACCOUNTS_PAYABLE_INVOICES; ?>">Accounts Payable Invoices</a></td>
												</tr>
											</table>
										</td>
									</tr>
