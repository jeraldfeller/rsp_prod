<?php
	...
	$return_page = ((isset($_GET['page'])) ? $_GET['page'] : '');
		...
		?>			
			...
			<?php
					...
					<table width="100%" class="pageBox" cellspacing="0" cellpadding="2">
						...
						<tr>
							<td class="pageBoxContent">ADC: </td><td class="pageBoxContent"><?php echo ((!empty($order_data['adc_number'])) ? $order_data['adc_number'] : 'None'); ?></td>
						</tr>
						<tr>
						...
						<tr>
							<td class="pageBoxContent">Miss Utility: </td>
                            <td class="pageBoxContent"><?php 
                        if ($order_data['lamp_yes_no'] == "yes" && 
                            $order_data['lamp_use_gas'] == "yes") {
                            echo "Property has a gas lamppost. Miss Utility has marked the property.";
                        } else if ($order_data['lamp_yes_no'] == "yes" && 
                            $order_data['lamp_use_gas'] == "no") {
                            echo "Agent indicates that the property has a yard lamp, but that it is not ";
                            echo "a gas lamp. But still be cautious installing the signpost near the yard lamp.";
                        } else if ($order_data['lamp_yes_no'] == "yes" && 
                            $order_data['lamp_use_gas'] == "unsure") {
                            echo "Property may have a gas lamppost. Miss Utility has marked the property.";
                        } else if ($order_data['miss_utility_yes_no'] == "no" && $order_data['lamp_yes_no'] == "no") {
                            echo "Not required.";
                        } else if ($order_data['miss_utility_yes_no'] == "yes") {
                            echo "Agent requested.";
                        }
                        ?></td>
						</tr>
						<tr>
				...
				<tr>
					<td width="100%">
						<table width="250" cellspacing="0" celpadding="0" class="pageBox">
							...
							<tr>
								<td class="pageBoxContent" align="right"><a href="<?php echo $return_page; ?>"><?php echo tep_create_button_link('back', 'Back'); ?></a></td>
							</tr>
						</table>
					</td>
				</tr>
