...
if (!empty($update_account) && ($update_account == 'update')) 
{
	...
	if (!$error->get_error_status('account_update')) 
	{
        ...
        $database->query("update " . TABLE_USERS . " set last_modified = '" . time() . "', email_address = '" . $form['email_address'] . "', billing_method_id = '" . $form['billing_method_id'] . "', service_level_id = '" . $form['service_level_id'] . "', agency_id = '" . $form['agency_id'] . "' where user_id = '" . $user->fetch_user_id() . "' limit 1");
