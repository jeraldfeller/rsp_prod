...
@session_start(); 
	...
	if ($payment_method == BILLING_METHOD_CREDIT) {
		...
		$pulldowns = array(
			'payment_method_id' => tep_draw_billing_method_pulldown_for_user_bgdn($agent_id, 'payment_method_id', $payment_method, 'change-submit', true, tep_fetch_agent_billing_method_id($agent_id)),
		...
		echo $twig->render('aom/aom_order_create_payment.html.twig', array('user' => $user, 'page' => $page, 'error'=>$error, 'order'=>$order, 'vars'=>$vars));
