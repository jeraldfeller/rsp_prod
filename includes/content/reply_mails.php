		...
		if (!empty($submit_type)) {
			//User has submitted form.  Now chech data and then insert into database.
				...
				if (!$error->get_error_status('account_create')) {
					...
					$database->query("insert into " . TABLE_USERS . " (date_created, email_address, password, agent_id, billing_method_id, service_level_id, agency_id) values ('" . mktime() . "', '" . $email_address . "', '" . md5($password) . "', '" . $agent_id . "', '" . $billing_method_id . "', '" . $service_level_id . "', '" . $agency_id . "')");
				...
				<tr>
					<td>
						<table cellpadding="0" cellspacing="3" border="0">
							...
							<tr>
								<td class="main">Alternate Email: </td><td><input type="text" name="alternate_email_address" value="<?php echo $alternateemail_address; ?>" /></td>
							</tr>
							<tr>
							...
							<tr>
								<!--<td class="main">Contact Name: </td>--><td class="main">Managing Broker: </td><td class="mainGrey"><?php echo $result['contact_name']; ?></td>
							</tr>
							<tr>
							...
							<tr>
								<!--<td class="main">Contact Name: </td>--><td class="main">Managing Broker: </td><td class="main"><input type="text" name="contact_name" value="<?php echo $contact_name; ?>" /></td>
							</tr>
							<tr>
