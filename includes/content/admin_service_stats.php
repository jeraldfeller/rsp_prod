...
if (isset($_GET['postsstats'])) {
	...
	if ($_GET['postsstats'] == 1) {
		...
		<?php
        foreach($database->fetch_array($query) as $year_stats){
			?>
			<tr>
...
if ($send_email) {
    $url = "http://" . $_SERVER['SERVER_NAME'] . "/lib/reports/service_stats_wrapper.php?average_install_length_since=" . urlencode($average_install_length_since);
...
function orderDetails(minDays, maxDays) {
    ...
    $.getJSON( "/lib/orders/open_orders_json.php?min=" + minDays + "&max=" + maxDays + "&since=" + since, function( data ) {
	...
	case '2': 
		...
		<tr>
			...
			<td align="left" class="main"><b>RESCHEDULED TODAY:</b> &nbsp;&nbsp;&nbsp;
						...
						Removals Rescheduled ( <?php echo $rescheduled_count; ?> ) &nbsp;&nbsp;

						Pushed Back ( <?php echo $pushed_back_count; ?> ) &nbsp;&nbsp;

						Moved Up ( <?php $moved_up_count; ?> ) &nbsp;&nbsp;
		...
		<tr>
			...
			<td width="100%">
				...
				<table width="100%" cellspacing="3" cellpadding="0" border="0">
					...
					<tr>
                        ...
                        <td align="left" class="main">
                            ...
                            <tbody>
                                ...
                                <td style="text-align: center; width: 50px;"> <a style="color: #1e90ff; cursor: pointer;" onclick="getAgentData({numberOfPost: '1'})"><?php echo $agents_with_1; ?></a></td>

                                <td style="text-align: center; width: 50px;"><a style="color: #1e90ff; cursor: pointer;" onclick="getAgentData({numberOfPost: '2'})"><?php echo $agents_with_2; ?></a></td></td>

                                <td style="text-align: center; width: 50px;"><a style="color: #1e90ff; cursor: pointer;" onclick="getAgentData({numberOfPost: '3-5'})"><?php echo $agents_with_5; ?></a></td>

                                <td style="text-align: center; width: 50px;"><a style="color: #1e90ff; cursor: pointer;" onclick="getAgentData({numberOfPost: '6-10'})"><?php echo $agents_with_10; ?></a></td>

                                <td style="text-align: center; width: 50px;"><a style="color: #1e90ff; cursor: pointer;" onclick="getAgentData({numberOfPost: '>11'})"><?php echo $agents_over_10; ?></a></td>

                                <td style="text-align: center; width: 50px;"><?php echo $agent_count; ?></td>
					...
					<tr>
                        ...
                        <td align="left" class="main">
                            ...
                            <tbody>
                                ...
                                <td style="text-align: center; width: 50px;"><a href="javascript:orderDetails(0,120);"><?php echo $posts_lte_120; ?></a></td>

                                <td style="text-align: center; width: 50px;"><a href="javascript:orderDetails(121,240);"><?php echo $posts_121_240; ?></a></td>

                                <td style="text-align: center; width: 50px;"><a href="javascript:orderDetails(241,360);"><?php echo $posts_241_360; ?></a></td>

                                <td style="text-align: center; width: 50px;"><a href="javascript:orderDetails(361,540);"><?php echo $posts_361_540; ?></a></td>

                                <td style="text-align: center; width: 50px;"><a href="javascript:orderDetails(541,720);"><?php echo $posts_541_720; ?></a></td>

                                <td style="text-align: center; width: 50px;"><a href="javascript:orderDetails(721);"><?php echo $posts_gte_721; ?></a></td>

                                <td style="text-align: center; width: 50px;"><?php echo $posts_count; ?></td>
                    ...
                    <td class="main">Average Time Installed (Currently Installed):<td class="main"><b>Mean:</b> <?php echo number_format($active_average,2); ?>&nbsp;days. &nbsp;&nbsp;&nbsp; <b>Median:</b> <?php echo number_format($active_median,2); ?> days.</td>

					</tr>

                    <td class="main">Average Time Installed (On Post Removal):<td class="main"><b>Mean:</b> <?php echo number_format($removed_average,2); ?>&nbsp;days. &nbsp;&nbsp;&nbsp; <b>Median:</b> <?php echo number_format($removed_median,2); ?> days.</td>
					...
					<td class="main">
					White PVC (<?php echo number_format(($white_pvc*100)/$sign_sum,2); ?>%)&nbsp;&nbsp;&nbsp;&nbsp;
					
					Black PVC (<?php echo number_format(($black_pvc*100)/$sign_sum,2); ?>%)&nbsp;&nbsp;&nbsp;&nbsp;
					
					Yellow PVC (<?php echo number_format(($yellow_pvc*100)/$sign_sum,2); ?>%)&nbsp;&nbsp;&nbsp;&nbsp;
					
					White wood (<?php echo number_format(($white_wood*100)/$sign_sum,2); ?>%)&nbsp;&nbsp;&nbsp;&nbsp;
					
					Black wood (<?php echo number_format(($black_wood*100)/$sign_sum,2); ?>%)&nbsp;&nbsp;&nbsp;&nbsp;
					
					Yellow wood (<?php echo number_format(($yellow_wood*100)/$sign_sum,2); ?>%)</td>
					...
					<td class="main">
					Silver (<?php echo number_format(($silver_level*100)/$levels_sum,2); ?>%)&nbsp;&nbsp;&nbsp;&nbsp;
					
					Gold (<?php echo number_format( (($gold_level*100)/$levels_sum),2); ?>%)&nbsp;&nbsp;&nbsp;&nbsp;
					
					Platinum (<?php echo number_format(($platinum_level*100)/$levels_sum,2); ?>%)&nbsp;&nbsp;&nbsp;&nbsp;
					</td>
...
<tr>
			...
			<td width="100%">
				<table width="100%" cellspacing="3" cellpadding="0" style="padding-left:15px;" border="0">
					<tr>
						...
						<td class="main" width="16%" ># of Installs:&nbsp;&nbsp;(&nbsp;<a href="<?php echo FILENAME_ADMIN_ORDERS; ?>?order_status=&order_type=1&show_house_number=&show_street_name=&show_city=&show_zip=&show_order_id=&list_method=1&show_address_id=&agent_id=&agency_id=&service_level_id=&inserted_order_type_id=&installer_id=&active=1&show_between_type=ordered&show_between_start=<?=date("m",$today)?>%2F<?=date("d",$today)?>%2F<?=date("Y",$today)?>&show_between_end=<?=date("m",$today)?>%2F<?=date("d",$today)?>%2F<?=date("Y",$today)?>&submit_value.x=41&submit_value.y=12" class="StatLink"><?=$count_install_today?></a>&nbsp;)</td>

						<td class="main" width="27%" >$ value of orders placed today:&nbsp;&nbsp;(&nbsp;<?php echo number_format ($value_install_today,2); ?>&nbsp;)</td>

						<td class="main" width="51%" >$ value / # of installs:&nbsp;&nbsp;(&nbsp;<?php if($count_install_today>0){ echo number_format(($value_install_today/$count_install_today),2);}else{echo "0.00";} ?>&nbsp;)&nbsp;&nbsp; </td>
					...
					<td class="main" width="22%">
					$ of CC Orders:&nbsp;&nbsp;(&nbsp;<?php echo number_format ($valueCC,2); ?>&nbsp;)&nbsp;&nbsp;
					</td>
					<td class="main" width="22%">
					$ of Invoice Orders:&nbsp;&nbsp;(&nbsp;
					    <?php echo number_format ($valueIO,2); ?>						  &nbsp;)
					</td>
					</tr>
					...
					<tr>
						...
						<td class="main" ># of Installs:&nbsp;&nbsp;(&nbsp;<a href="<?php echo FILENAME_ADMIN_ORDERS; ?>?order_status=&order_type=1&show_house_number=&show_street_name=&show_city=&show_zip=&show_order_id=&list_method=1&show_address_id=&agent_id=&agency_id=&service_level_id=&inserted_order_type_id=&installer_id=&active=1&show_between_type=ordered&show_between_start=<?=date("m",$month_first_date)?>%2F<?=date("d",$month_first_date)?>%2F<?=date("Y",$month_first_date)?>&show_between_end=<?=date("m",$today)?>%2F<?=date("d",$today)?>%2F<?=date("Y",$today)?>&submit_value.x=41&submit_value.y=12" class="StatLink"><?php $count_install_month; ?></a>&nbsp;)</td>

						<td class="main" >$ value of orders placed this month:&nbsp;&nbsp;(&nbsp;<?php echo number_format($value_install_month,2); ?>&nbsp;)</td>

						<td class="main" colspan="3" >$ value / # of installs:&nbsp;&nbsp;(&nbsp;<?php if($count_install_month>0){ echo number_format(($value_install_month/$count_install_month),2);}else{echo "0.00";}?>&nbsp;)</td>
					...
					<tr>
						...
						<td class="main" ># of Installs:&nbsp;&nbsp;(&nbsp;<a href="<?php echo FILENAME_ADMIN_ORDERS; ?>?order_status=3&order_type=1&show_house_number=&show_street_name=&show_city=&show_zip=&show_order_id=&list_method=1&show_address_id=&agent_id=&agency_id=&service_level_id=&inserted_order_type_id=&installer_id=&active=1&show_between_type=completed&show_between_start=<?=date("m",$month_first_date)?>%2F<?=date("d",$month_first_date)?>%2F<?=date("Y",$month_first_date)?>&show_between_end=<?=date("m",$today)?>%2F<?=date("d",$today)?>%2F<?=date("Y",$today)?>&submit_value.x=41&submit_value.y=12" class="StatLink"><?php $this_month_complete_count; ?></a>&nbsp;)</td>

						<td class="main" >$ value of orders completed this month:&nbsp;&nbsp;(&nbsp;<?php echo number_format($this_month_complete_value,2); ?>&nbsp;)</td>

						<td class="main" colspan="3" >$ value / # of installs:&nbsp;&nbsp;(&nbsp;<?php if($this_month_complete_count>0){ echo number_format(($this_month_complete_value/$this_month_complete_count),2);}else{echo "0.00";}?></td>
					...
					<td class="main" width="22%">
					% of CC Orders:&nbsp;&nbsp;(&nbsp;<?php echo number_format ($countCC_percentage_month,2); ?>%&nbsp;)&nbsp;&nbsp;
					</td>
					<td class="main" width="22%">
					% of Invoice Orders:&nbsp;&nbsp;(&nbsp;
					    <?php number_format ($countIO_percentage_month,2); ?>%&nbsp;)
					</td>
					</tr>
					...
					<tr>
						...
						<td class="main" ># of Installs:&nbsp;&nbsp;(&nbsp;<a href="<?php echo FILENAME_ADMIN_ORDERS; ?>?order_status=3&order_type=1&show_house_number=&show_street_name=&show_city=&show_zip=&show_order_id=&list_method=1&show_address_id=&agent_id=&agency_id=&service_level_id=&inserted_order_type_id=&installer_id=&active=1&show_between_type=completed&show_between_start=<?php echo date("m",$year_first_date); ?>%2F<?php echo date("d",$year_first_date); ?>%2F<?php echo date("Y",$year_first_date); ?>&show_between_end=<?php echo date("m",$today); ?>%2F<?php echo date("d",$today); ?>%2F<?=date("Y",$today)?>&submit_value.x=41&submit_value.y=12" class="StatLink"><?=$count_install_ytd?></a>&nbsp;)</td>
						...
						<td class="main" colspan="3">$ value / # of installs:&nbsp;&nbsp;(&nbsp;<?php if($count_install_ytd>0){ echo number_format(($value_install_ytd/$count_install_ytd),2);}else{echo "0.00";}?>&nbsp;)&nbsp;&nbsp;</td>
					</tr>
					...
					<tr>
					 ...
					 <tr>
                        ...
                        <td class="main" colspan="3" >$ value / # of installs:&nbsp;&nbsp;(&nbsp;<?php if($previous_month_count>0){ echo number_format(($previous_month_value/$previous_month_count),2);}else{echo "0.00";}?>&nbsp;)</td>
			...
			<td width="100%">
				...
				<table width="100%" cellspacing="3" cellpadding="0" style="padding-left:15px;" border="0">
					...
					<tr>
						...
						<td class="main" >$ value / # of installs:&nbsp;&nbsp;(&nbsp;<?php if($count_install_month>0){ echo number_format(($value_install_month/$count_install_month),2);}else{echo "0.00";}?>&nbsp;)</td></td>
		...
		<tr>
            <td>
            <iframe src="/lib/charts/orders_distribution_map.php" width="100%" height="600"></iframe>
            </td>
		</tr>
			<tr>
				<td align="left" class="main">&nbsp;</td>
...
<!-- Modal -->
        <div id="agentsNumberPostsModal" class="modal fade" role="dialog">
        ...
        <!-- end modal -->
        <script src="http://beta.odatnow.com/jbenterprises/web/assets/global/plugins/datatables/datatables.min.js"></script>
        <script>
            $(document).on('ready', function(){
                $('#responsive-table-agents').DataTable({
                    "ajax": '../../lib/service_stats/get_agent_data.php?numberOfPost=0&averageSinceTs=0'
                });

                $(".datepicker").datepicker();

                $('#responsive-table-agents_length select').css('width', '41%');
                $('#responsive-table-agents_filter input:text').css('width', '70%');

            });


            function getAgentData(data){
                $('#agentsNumberPostsModal .modal-title').html('<img width="50" height="50" src="images/ajax-loader.gif">');
                $('#agentsNumberPostsModal').modal('show');
                var table = $('#responsive-table-agents').DataTable();
                table.clear().draw();
                table.ajax.url( '../../lib/service_stats/get_agent_data.php?numberOfPost='+ data.numberOfPost +'&averageSinceTs=<?php echo $average_since_ts; ?>').load(function(){
                    $('#agentsNumberPostsModal .modal-title').html('Number of post: ' + data.numberOfPost);
                });
            }
        </script>
